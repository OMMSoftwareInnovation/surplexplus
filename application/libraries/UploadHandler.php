...
class UploadHandler
{
    ...
    protected function set_additional_file_properties($file) {
        ...
        // $file->delete_url = site_url().'sellercontroller/deleteFile/'.rawurlencode($file->name);
        $file->deleteUrl = site_url().'/sellercontroller/deleteFile/'
...
function add_img($data,$size,$name,$file)  
{  
  /*  $add_to_db = $this->query("INSERT INTO img
...
// $file->upload_to_db = $this->add_img($data, $size,  $file->name,$file);
  return $file;    
    }
