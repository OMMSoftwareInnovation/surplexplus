...
<div class="tab-pane" id="Registration1">
                                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('homecontroller/buyer_registraion'); ?>">
  ...
  , confirm_password = document.getElementById("confirm_password");
    ...
    var  cnt=0;
        $('#chk_avail').click(function() 
        {
            ...
            if (name.length >= 3) 
            {
                $.post('<?php echo site_url('homecontroller/chk_buyer_usr'); ?>', {seller_username: name}, function(d) {
                    if (d == 1)
                    {
        ...
        $( "#email" ).keyup(function() 
        {
            ...
            {
                var name = $('#email').val();
                $.post('<?php echo site_url('homecontroller/chk_buyer_email'); ?>', {seller_email: name}, function(d) 
                {
                    if (d == 1)
                    {
