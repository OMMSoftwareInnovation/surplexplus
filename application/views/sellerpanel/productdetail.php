...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="text-center">
          ...
          {
              echo "<span class='text-green'><b>(Approved)</b></span>";
          }
          else
          {
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <!-- /.box -->
          <!-- About Me Box -->
          <div class="box box-primary text-center" style="visibility: hidden;">
            <div class="box-header with-border">
              <h3 class="box-title" style="font-size: 21px;">SurplexPlus</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">

              <i class="fa fa-th-list margin-r-5"></i> SurplexPlus

              <p class="text-muted"><a style="font-size: 23px;">SurplexPlus</a></p>

              <hr>

              <i class="fa fa-tags margin-r-5"></i> SurplexPlus
                    ...
                    <div class="row margin-bottom">
                        ...
                        ?>
                          <div class="col-sm-3" style="margin-top: 10px;">
                            <img class="img-responsive img" src="<?php echo base_url() ?>files/<?php echo $img[$i] ?>"
